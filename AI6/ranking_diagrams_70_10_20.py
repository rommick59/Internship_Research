"""Ranking + diagrams for the split 0.70/0.10/0.20 (AI6).

Reads results from Internship_Research/AI6 and writes rankings/figures there.

Outputs:
- Internship_Research/AI6/rankings_70_10_20.csv
- Internship_Research/AI6/rankings_70_10_20.md
- Internship_Research/AI6/images/ranking_70_10_20_train.png
- Internship_Research/AI6/images/ranking_70_10_20_test.png
- Internship_Research/AI6/images/ranking_70_10_20_gap.png

Run (PowerShell):
  c:/Users/siame/Desktop/Stage/.venv/Scripts/python.exe Internship_Research/AI6/ranking_diagrams_70_10_20.py
"""
...
def build_metrics_table(models: list[tuple[str, Path]], split: Split) -> pd.DataFrame:
    ...
    if not rows:
        raise ValueError(f"No results found in {models}")
...
def main() -> int:
    p = argparse.ArgumentParser(description="Ranking + diagrams for split 0.70/0.10/0.20 (AI6)")
    p.add_argument(
        "--split",
        type=str,
        default="0.7,0.1,0.2",
    ...
    p.add_argument(
        "--ai-dir",
        type=Path,
        default=Path("Internship_Research/AI6"),
        help="Folder containing *_results.csv",
    )
    p.add_argument(
        "--out-rankings-csv",
        type=Path,
        default=Path("Internship_Research/AI6/rankings_70_10_20.csv"),
    )
    p.add_argument(
        "--out-rankings-md",
        type=Path,
        default=Path("Internship_Research/AI6/rankings_70_10_20.md"),
    )
    p.add_argument(
        "--out-dir-images",
        type=Path,
        default=Path("Internship_Research/AI6/images"),
    )
