"""AI7 — Ranking + diagrams for the split 0.80/0.00/0.20.

Reads results from Internship_Research/AI7 and writes rankings/figures there.
Uses TRAIN and TEST metrics only (no validation for 80/20).

Outputs:
- Internship_Research/AI7/rankings_80_20.csv
- Internship_Research/AI7/rankings_80_20.md
- Internship_Research/AI7/images/ranking_80_20_train.png
- Internship_Research/AI7/images/ranking_80_20_test.png
- Internship_Research/AI7/images/ranking_80_20_gap.png

Run (PowerShell):
  c:/Users/siame/Desktop/Stage/.venv/Scripts/python.exe Internship_Research/AI7/ranking_diagrams_80_20.py
"""
...
def main() -> int:
    p = argparse.ArgumentParser(description="AI7 ranking + diagrams for split 80/20")
    p.add_argument("--ai-dir", type=Path, default=Path("Internship_Research/AI7"))
    p.add_argument("--out-rankings-csv", type=Path, default=Path("Internship_Research/AI7/rankings_80_20.csv"))
    p.add_argument("--out-rankings-md", type=Path, default=Path("Internship_Research/AI7/rankings_80_20.md"))
    p.add_argument("--out-dir-images", type=Path, default=Path("Internship_Research/AI7/images"))
    args = p.parse_args()
