"""AI7 — Split 80/20 then normalize (fit on TRAIN only).
...
Outputs:
- Internship_Research/AI7/split_train_norm_80_20.csv
- Internship_Research/AI7/split_test_norm_80_20.csv
- Internship_Research/AI7/preprocessor_fit_on_train_80_20.joblib
- Internship_Research/AI7/split_indices_80_20.joblib

Run (PowerShell):
  c:/Users/siame/Desktop/Stage/.venv/Scripts/python.exe Internship_Research/AI7/build_split_and_normalize_train_only_80_20.py
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="AI7: split 80/20 then normalize (fit on train only)")
    p.add_argument(
        "--input-csv",
        type=Path,
    ...
    p.add_argument(
        "--save-preprocessor",
        type=Path,
        default=Path("Internship_Research/AI7/preprocessor_fit_on_train_80_20.joblib"),
    )
    p.add_argument(
        "--save-indices",
        type=Path,
        default=Path("Internship_Research/AI7/split_indices_80_20.joblib"),
    )
    return p.parse_args()
