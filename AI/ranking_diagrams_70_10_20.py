"""Ranking + diagrams for the split 0.70/0.10/0.20.
...
4) Generates diagrams (bar charts) for key TEST metrics and an overfitting view

Outputs:
- Internship_Research/AI/rankings_70_10_20.csv
- Internship_Research/AI/rankings_70_10_20.md
- Internship_Research/images/ranking_70_10_20_train.png
- Internship_Research/images/ranking_70_10_20_test.png
- Internship_Research/images/ranking_70_10_20_gap.png

Run (PowerShell):
  c:/Users/siame/Desktop/Stage/.venv/Scripts/python.exe Internship_Research/AI/ranking_diagrams_70_10_20.py
...
def plot_barh(ax, series: pd.Series, title: str, better: str) -> None:
    ...
    if better == "higher":
        ordered = series.sort_values(ascending=True)  # barh bottom->top
    else:
...
def main() -> int:
    p = argparse.ArgumentParser(description="Ranking + diagrams for split 0.70/0.10/0.20")
    p.add_argument(
        "--split",
        type=str,
        default="0.7,0.1,0.2",
    ...
    p.add_argument(
        "--out-rankings-csv",
        type=Path,
        default=Path("Internship_Research/AI/rankings_70_10_20.csv"),
    )
    p.add_argument(
        "--out-rankings-md",
        type=Path,
        default=Path("Internship_Research/AI/rankings_70_10_20.md"),
    )
    p.add_argument(
        "--out-dir-images",
        type=Path,
        default=Path("Internship_Research/images"),
    )
    ...
    # Diagrams: key TRAIN and TEST metrics + gap train->test
