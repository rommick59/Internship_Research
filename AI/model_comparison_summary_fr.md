...
## Résultat principal
La **Random Forest** et le **SVR** surpassent la **régression linéaire** sur les splits testés (R² plus élevé et erreurs plus faibles).

## Recommandation finale (modèle + split)
- **Modèle recommandé (selon le critère)**:
  - **RMSE (et R²)**: **SVR** (meilleur RMSE/R² sur les splits testés)
  - **MAE**: **Random Forest** (meilleur MAE sur les splits testés)
...
- R (corrélation) moyen: linéaire = 0.998012 vs random forest = 0.998839 vs SVR = 0.999426
- R² moyen: linéaire = 0.996009 vs random forest = 0.997609 vs SVR = 0.998842
- MSE moyen: linéaire ≈ 0.000225 vs random forest ≈ 0.000135 vs SVR ≈ 0.000065
- RMSE moyen: linéaire ≈ 0.014985 vs random forest ≈ 0.011585 vs SVR ≈ 0.008052
- MAE moyen: linéaire ≈ 0.010530 vs random forest ≈ 0.004643 vs SVR ≈ 0.005525
...
- **SVR** fournit les meilleures performances selon **RMSE** (et globalement **R²**).
- **Random Forest** fournit les meilleures performances selon **MAE**.
