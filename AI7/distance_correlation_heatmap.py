"""Distance correlation heatmap for AI7.

Adapted from AI5 version to use AI7 normalised split by default.

Input (default):
- Internship_Research/AI7/split_train_norm_80_20.csv

Output:
- Internship_Research/AI7/images/heatmap_distance_correlation_ai7.png
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Distance correlation heatmap (AI7)")
    p.add_argument(
        "--csv",
        type=Path,
    ...
    p.add_argument(
        "--out",
        type=Path,
        default=Path("Internship_Research/AI7/images/heatmap_distance_correlation_ai7.png"),
        help="Output PNG",
    )
    p.add_argument(
        "--dpi",
...
def plot_heatmap(mat: pd.DataFrame, out_path: Path, dpi: int) -> None:
    ...
    ax.set_title("Distance Correlation Heatmap (AI7)")
