"""AI7 — Cross-validation on the TRAIN subset (80%) with fold-wise train-only normalization.
...
Outputs:
- Internship_Research/AI7/cv_results_80_20.csv
- Internship_Research/AI7/cv_results_80_20.md

Run (PowerShell):
  c:/Users/siame/Desktop/Stage/.venv/Scripts/python.exe Internship_Research/AI7/cross_validation_train_only_80_20.py
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="AI7: CV on train subset with fold-wise train-only normalization")
    p.add_argument(
        "--input-csv",
        type=Path,
    ...
    p.add_argument(
        "--out-csv",
        type=Path,
        default=Path("Internship_Research/AI7/cv_results_80_20.csv"),
    )
    p.add_argument(
        "--out-md",
        type=Path,
        default=Path("Internship_Research/AI7/cv_results_80_20.md"),
    )
    return p.parse_args()
