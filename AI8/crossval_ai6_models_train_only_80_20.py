"""AI8 — Cross-validation on TRAIN (80%) using AI6 model set (NO CRS).
...
Consumes:
- Internship_Research/AI8/split_train_raw_80_20.csv  (raw numeric, unscaled)

Outputs:
- Internship_Research/AI8/cv_folds_80_20.csv     (one row per model per fold)
- Internship_Research/AI8/cv_summary_80_20.csv   (mean/std per model)
- Internship_Research/AI8/cv_summary_80_20.md

Run (PowerShell):
    c:/Users/siame/Desktop/Stage/.venv/Scripts/python.exe Internship_Research/AI8/crossval_ai6_models_train_only_80_20.py
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="AI8: cross-validation on TRAIN only (80/20 split)")
    p.add_argument(
        "--train-raw-csv",
        type=Path,
        default=Path("Internship_Research/AI8/split_train_raw_80_20.csv"),
    )
    p.add_argument("--target", type=str, default="PR(mm/r)")
    p.add_argument("--n-splits", type=int, default=5)
    p.add_argument("--random-state", type=int, default=42)
    p.add_argument("--out-folds", type=Path, default=Path("Internship_Research/AI8/cv_folds_80_20.csv"))
    p.add_argument("--out-summary", type=Path, default=Path("Internship_Research/AI8/cv_summary_80_20.csv"))
    p.add_argument("--out-md", type=Path, default=Path("Internship_Research/AI8/cv_summary_80_20.md"))
    return p.parse_args()
