"""AI7 — Draw the requested normalization+IA schema (80% train, 20% test).

Output:
- Internship_Research/AI7/images/schema_normalization_train_test_80_20.png

Run (PowerShell):
  c:/Users/siame/Desktop/Stage/.venv/Scripts/python.exe Internship_Research/AI7/normalization_schema_80_20.py
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="AI7 schema diagram")
    p.add_argument(
        "--out",
        type=Path,
        default=Path("Internship_Research/AI7/images/schema_normalization_train_test_80_20.png"),
        help="Output PNG",
    )
...
def main() -> int:
    ...
    ax.set_title("AI7 — Schéma normalisation + IA (80% TRAIN, 20% TEST)")
